...
sudo pacman -Syyu
sudo pacman -Syu
sudo pacman -S base-devel x11-ssh-askpass fish python-pip python-wxpython jre-openjdk libstdc++5 flite libreoffice-fresh gcc-fortran r yay gimp flatpak caprine calibre flameshot gparted htop qbittorrent vlc etcher pdftk virtualbox aspell hspell libvoikko --needed
